...
void chuta(){
    ...
    if(letra_existe(chute)){
        cout << "VocÃª acertou! Seu chute estÃ¡ na palavra." << endl;
    }
    else{
        cout << "VocÃª errou! Seu chute nÃ£o estÃ¡ na palavra." << endl;
...
vector<string> le_arquivo(){
    ...
    if(arquivo.is_open()){
        ...
        cout << "NÃ£o foi possÃ­vel acessar o banco de palavras." << endl;
        exit(0);
    }
}
